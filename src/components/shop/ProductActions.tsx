  ...
  return (
    <div className="mt-6 flex flex-col gap-4 border-t border-gray-100 pt-6">
      ...
      <button
        ...
        className="w-full bg-primary-600 hover:bg-primary-700 text-white font-bold py-4 rounded shadow-lg transition-colors flex items-center justify-center gap-2 mt-2"
      >
