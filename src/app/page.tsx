...
export default function GroupHomePage() {
  return (
    <div className="flex flex-col min-h-screen bg-surface-50">
      ...
      <section className="relative h-[85vh] w-full flex items-center bg-primary-900 border-b-8 border-accent-500 overflow-hidden" 
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10 flex flex-col items-center justify-center min-h-full py-20">
          <div className="w-full max-w-4xl text-center drop-shadow-2xl">
            ...
            <h1 className="text-5xl md:text-7xl font-extrabold text-white mb-6 leading-tight drop-shadow-[0_5px_5px_rgba(0,0,0,0.8)]">
              Driving Growth. <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-surface-200 drop-shadow-[0_5px_5px_rgba(0,0,0,0.8)]">Building the Future.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
               ...
               <Link href="/about" className="interactive-hover px-8 py-4 bg-transparent border-2 border-surface-400 hover:border-white text-white rounded-lg font-bold text-lg transition-colors text-center">
                   Corporate Profile
               </Link>
            </div>
          </div>
      ...
      <section className="py-24 px-4 md:px-8">
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
             <div className="max-w-2xl">
                 ...
                 <h3 className="text-4xl md:text-5xl font-extrabold text-primary-900 leading-tight">
                    Diverse operations, unified by <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-accent-600">quality.</span>
                 </h3>
             </div>
             <Link href="/businesses" className="text-primary-600 font-bold hover:text-primary-800 flex items-center gap-2 transition-colors whitespace-nowrap">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
             {/* Flour Division Card */}
             <div className="bg-white rounded-2xl overflow-hidden shadow-lg border border-surface-200 interactive-hover group">
                <div className="h-64 bg-surface-200 relative overflow-hidden">
                    ...
                    <div className="absolute bottom-6 left-6 z-20">
                        <h4 className="text-white font-bold text-2xl drop-shadow-md">Flour Milling</h4>
                    </div>
                </div>
                <div className="p-8">
             ...
             {/* Logistics Division Card */}
             <div className="bg-white rounded-2xl overflow-hidden shadow-lg border border-surface-200 interactive-hover group">
                <div className="h-64 bg-surface-200 relative overflow-hidden">
                    <div className="absolute inset-0 bg-primary-900/60 group-hover:bg-primary-900/40 transition-colors z-10"></div>
                    {/* Placeholder for Logistics Image */}
                    <div className="absolute inset-0 flex items-center justify-center p-12">
                    ...
                    <div className="absolute bottom-6 left-6 z-20">
                        <h4 className="text-white font-bold text-2xl drop-shadow-md">Logistics & Supply</h4>
                    </div>
                </div>
                <div className="p-8">
                    <p className="text-surface-600 leading-relaxed mb-6">
             ...
             <div className="bg-white rounded-2xl overflow-hidden shadow-lg border border-surface-200 interactive-hover group">
                <div className="h-64 bg-surface-200 relative overflow-hidden">
                    ...
                    <div className="absolute bottom-6 left-6 z-20">
                        <h4 className="text-white font-bold text-2xl drop-shadow-md">Agro-Allied</h4>
                    </div>
                </div>
                <div className="p-8">
                    <p className="text-surface-600 leading-relaxed mb-6">
      ...
      <section className="bg-surface-100 py-20 px-4 border-t border-surface-200">
        <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-extrabold text-primary-900 mb-6">Committed to Continuous Value Creation</h2>
            ...
            <Link href="/contact" className="inline-block bg-primary-900 hover:bg-primary-800 text-white font-bold py-4 px-10 rounded-lg shadow-lg transition-transform hover:-translate-y-1">
                Partner With Us
            </Link>
        </div>
      </section>
