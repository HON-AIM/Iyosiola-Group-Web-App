...
export default function SocialMediaPage() {
  ...
  const SocialIcon = ({ name }: { name: string }) => {
    const icons: Record<string, JSX.Element> = {
      ...
      "Twitter/X": <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>,
      ...
      YouTube: <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.805 6.892 18.5 6.5 12 6.5c-6.804 0-7.805.392-9.377.05a3.015 3.015 0 0 0-2.122 2.136C.05 10.392 0 12.05 0 12.05c0 1.658.05 3.33.05 4.864 0 1.658-.05 3.33-.05 4.864 0 1.658.05 3.33.05 4.864 0 1.658-.05 3.33-.05 4.864 0 1.658.05 3.33.05 4.864 0 1.658-.05 3.33-.05 4.864 0 1.658.05 3.33.05 4.864 0 1.658-.05 3.33-.05 4.864 0 1.658.05 3.33.05 4.864 0 1.658-.05 3.33-.05 4.864 0 1.658.05 3.33.05 4.864zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>,
    };
